...
def parse_opts_metrics_plot():
    ...
    parser.add_argument("--only_recall", action="store_true", help="Plot only Recall")
    parser.add_argument("--no_accuracy", action="store_true", help="Does not display the accuracy")
